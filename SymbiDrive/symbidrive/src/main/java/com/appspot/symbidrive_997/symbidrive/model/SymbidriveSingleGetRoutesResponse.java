...
/**
 * Model definition for SymbidriveSingleGetRoutesResponse.
 *
...
public final class SymbidriveSingleGetRoutesResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public SymbidriveSingleGetRoutesResponse setDriverSocialID(java.lang.String driverSocialID) {
   ...
   */
  public SymbidriveSingleGetRoutesResponse setId(java.lang.Long id) {
    this.id = id;
    return this;
  }
   ...
   */
  public SymbidriveSingleGetRoutesResponse setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public SymbidriveSingleGetRoutesResponse setRoutePointsLat(java.util.List<java.lang.Double> routePointsLat) {
   ...
   */
  public SymbidriveSingleGetRoutesResponse setRoutePointsLong(java.util.List<java.lang.Double> routePointsLong) {
    this.routePointsLong = routePointsLong;
    return this;
  }

  @Override
  public SymbidriveSingleGetRoutesResponse set(String fieldName, Object value) {
    return (SymbidriveSingleGetRoutesResponse) super.set(fieldName, value);
  }

  @Override
  public SymbidriveSingleGetRoutesResponse clone() {
    return (SymbidriveSingleGetRoutesResponse) super.clone();
  }
