...
public final class SymbidriveSinglePoolResponse extends com.google.api.client.json.GenericJson {
   ...
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key("passengers_ids")
  private java.util.List<java.lang.String> passengersIds;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<java.lang.String> getPassengersIds() {
    return passengersIds;
  }

  /**
   * @param passengersIds passengersIds or {@code null} for none
   */
  public SymbidriveSinglePoolResponse setPassengersIds(java.util.List<java.lang.String> passengersIds) {
