 ...
 * on 2015-07-05 at 11:20:45 UTC 
 * Modify at your own risk.
 */

package com.appspot.symbidrive_997.symbidrive;
...
public class Symbidrive extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://1-dot-symbidrive-997.appspot.com/_ah/api/";
   ...
   *
   * @param content the {@link com.appspot.symbidrive_997.symbidrive.model.SymbidriveAddFeedbackRequest}
   * @return the request
   */
  public AddFeedback addFeedback(com.appspot.symbidrive_997.symbidrive.model.SymbidriveAddFeedbackRequest content) throws java.io.IOException {
    AddFeedback result = new AddFeedback(content);
    initialize(result);
    return result;
  }

  public class AddFeedback extends SymbidriveRequest<com.appspot.symbidrive_997.symbidrive.model.SymbidriveUserResponse> {
     ...
     * @since 1.13
     */
    protected AddFeedback(com.appspot.symbidrive_997.symbidrive.model.SymbidriveAddFeedbackRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.symbidrive_997.symbidrive.model.SymbidriveUserResponse.class);
    }
   ...
   *
   * @param content the {@link com.appspot.symbidrive_997.symbidrive.model.SymbidriveManagePassangerRequest}
   * @return the request
   */
  public AddPassengerToPool addPassengerToPool(com.appspot.symbidrive_997.symbidrive.model.SymbidriveManagePassangerRequest content) throws java.io.IOException {
    AddPassengerToPool result = new AddPassengerToPool(content);
    initialize(result);
    return result;
  }

  public class AddPassengerToPool extends SymbidriveRequest<com.appspot.symbidrive_997.symbidrive.model.SymbidrivePoolResponse> {
     ...
     * @since 1.13
     */
    protected AddPassengerToPool(com.appspot.symbidrive_997.symbidrive.model.SymbidriveManagePassangerRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.symbidrive_997.symbidrive.model.SymbidrivePoolResponse.class);
    }
   ...
   *
   * @param content the {@link com.appspot.symbidrive_997.symbidrive.model.SymbidriveAddRatingRequest}
   * @return the request
   */
  public AddRating addRating(com.appspot.symbidrive_997.symbidrive.model.SymbidriveAddRatingRequest content) throws java.io.IOException {
    AddRating result = new AddRating(content);
    initialize(result);
    return result;
  }

  public class AddRating extends SymbidriveRequest<com.appspot.symbidrive_997.symbidrive.model.SymbidriveUserResponse> {
     ...
     * @since 1.13
     */
    protected AddRating(com.appspot.symbidrive_997.symbidrive.model.SymbidriveAddRatingRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.symbidrive_997.symbidrive.model.SymbidriveUserResponse.class);
    }
   ...
   *
   * @param content the {@link com.appspot.symbidrive_997.symbidrive.model.SymbidriveCreatePoolRequest}
   * @return the request
   */
  public CreatePool createPool(com.appspot.symbidrive_997.symbidrive.model.SymbidriveCreatePoolRequest content) throws java.io.IOException {
    CreatePool result = new CreatePool(content);
    initialize(result);
    return result;
  }

  public class CreatePool extends SymbidriveRequest<com.appspot.symbidrive_997.symbidrive.model.SymbidrivePoolResponse> {
     ...
     * @since 1.13
     */
    protected CreatePool(com.appspot.symbidrive_997.symbidrive.model.SymbidriveCreatePoolRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.symbidrive_997.symbidrive.model.SymbidrivePoolResponse.class);
    }
   ...
   *
   * @param content the {@link com.appspot.symbidrive_997.symbidrive.model.SymbidriveCreateRouteRequest}
   * @return the request
   */
  public CreateRoute createRoute(com.appspot.symbidrive_997.symbidrive.model.SymbidriveCreateRouteRequest content) throws java.io.IOException {
    CreateRoute result = new CreateRoute(content);
    initialize(result);
    return result;
  }

  public class CreateRoute extends SymbidriveRequest<com.appspot.symbidrive_997.symbidrive.model.SymbidriveCreateRouteResponse> {
     ...
     * @since 1.13
     */
    protected CreateRoute(com.appspot.symbidrive_997.symbidrive.model.SymbidriveCreateRouteRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.symbidrive_997.symbidrive.model.SymbidriveCreateRouteResponse.class);
    }
   ...
   * @return the request
   */
  public DeletePassengerFromPool deletePassengerFromPool(com.appspot.symbidrive_997.symbidrive.model.SymbidriveManagePassangerRequest content) throws java.io.IOException {
    DeletePassengerFromPool result = new DeletePassengerFromPool(content);
    initialize(result);
    return result;
  }

  public class DeletePassengerFromPool extends SymbidriveRequest<com.appspot.symbidrive_997.symbidrive.model.SymbidrivePoolResponse> {
     ...
     * @since 1.13
     */
    protected DeletePassengerFromPool(com.appspot.symbidrive_997.symbidrive.model.SymbidriveManagePassangerRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.symbidrive_997.symbidrive.model.SymbidrivePoolResponse.class);
    }
   ...
   *
   * @param content the {@link com.appspot.symbidrive_997.symbidrive.model.SymbidriveDeletePoolRequest}
   * @return the request
   */
  public DeletePool deletePool(com.appspot.symbidrive_997.symbidrive.model.SymbidriveDeletePoolRequest content) throws java.io.IOException {
    DeletePool result = new DeletePool(content);
    initialize(result);
    return result;
  }

  public class DeletePool extends SymbidriveRequest<com.appspot.symbidrive_997.symbidrive.model.SymbidrivePoolResponse> {
     ...
     * @since 1.13
     */
    protected DeletePool(com.appspot.symbidrive_997.symbidrive.model.SymbidriveDeletePoolRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.symbidrive_997.symbidrive.model.SymbidrivePoolResponse.class);
    }
   ...
   *
   * @param content the {@link com.appspot.symbidrive_997.symbidrive.model.SymbidriveFindPoolRequest}
   * @return the request
   */
  public FindPool findPool(com.appspot.symbidrive_997.symbidrive.model.SymbidriveFindPoolRequest content) throws java.io.IOException {
    FindPool result = new FindPool(content);
    initialize(result);
    return result;
  }

  public class FindPool extends SymbidriveRequest<com.appspot.symbidrive_997.symbidrive.model.SymbidriveFindPoolResponse> {
     ...
     * @since 1.13
     */
    protected FindPool(com.appspot.symbidrive_997.symbidrive.model.SymbidriveFindPoolRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.symbidrive_997.symbidrive.model.SymbidriveFindPoolResponse.class);
    }
   ...
   *
   * @param content the {@link com.appspot.symbidrive_997.symbidrive.model.SymbidriveGetRoutesRequest}
   * @return the request
   */
  public GetRoutes getRoutes(com.appspot.symbidrive_997.symbidrive.model.SymbidriveGetRoutesRequest content) throws java.io.IOException {
    GetRoutes result = new GetRoutes(content);
    initialize(result);
    return result;
  }

  public class GetRoutes extends SymbidriveRequest<com.appspot.symbidrive_997.symbidrive.model.SymbidriveGetRoutesResponse> {
     ...
     * @since 1.13
     */
    protected GetRoutes(com.appspot.symbidrive_997.symbidrive.model.SymbidriveGetRoutesRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.symbidrive_997.symbidrive.model.SymbidriveGetRoutesResponse.class);
    }
   ...
   *
   * @param content the {@link com.appspot.symbidrive_997.symbidrive.model.SymbidriveUserInfoRequest}
   * @return the request
   */
  public GetUserInfo getUserInfo(com.appspot.symbidrive_997.symbidrive.model.SymbidriveUserInfoRequest content) throws java.io.IOException {
    GetUserInfo result = new GetUserInfo(content);
    initialize(result);
    return result;
  }

  public class GetUserInfo extends SymbidriveRequest<com.appspot.symbidrive_997.symbidrive.model.SymbidriveUserInfoResponse> {
     ...
     * @since 1.13
     */
    protected GetUserInfo(com.appspot.symbidrive_997.symbidrive.model.SymbidriveUserInfoRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.symbidrive_997.symbidrive.model.SymbidriveUserInfoResponse.class);
    }
   ...
   *
   * @param content the {@link com.appspot.symbidrive_997.symbidrive.model.SymbidriveRegisterUserRequest}
   * @return the request
   */
  public RegisterUser registerUser(com.appspot.symbidrive_997.symbidrive.model.SymbidriveRegisterUserRequest content) throws java.io.IOException {
    RegisterUser result = new RegisterUser(content);
    initialize(result);
    return result;
  }

  public class RegisterUser extends SymbidriveRequest<com.appspot.symbidrive_997.symbidrive.model.SymbidriveUserResponse> {
     ...
     * @since 1.13
     */
    protected RegisterUser(com.appspot.symbidrive_997.symbidrive.model.SymbidriveRegisterUserRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.symbidrive_997.symbidrive.model.SymbidriveUserResponse.class);
    }
   ...
   *
   * @param content the {@link com.appspot.symbidrive_997.symbidrive.model.SymbidriveUpdateUserInfoRequest}
   * @return the request
   */
  public UpdateUserProfile updateUserProfile(com.appspot.symbidrive_997.symbidrive.model.SymbidriveUpdateUserInfoRequest content) throws java.io.IOException {
    UpdateUserProfile result = new UpdateUserProfile(content);
    initialize(result);
    return result;
  }

  public class UpdateUserProfile extends SymbidriveRequest<com.appspot.symbidrive_997.symbidrive.model.SymbidriveUserResponse> {
     ...
     * @since 1.13
     */
    protected UpdateUserProfile(com.appspot.symbidrive_997.symbidrive.model.SymbidriveUpdateUserInfoRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.symbidrive_997.symbidrive.model.SymbidriveUserResponse.class);
    }
  ...
  /**
   * Create a request for the method "view_pools".
   *
   * This request holds the parameters needed by the symbidrive server.  After setting any optional
   * parameters, call the {@link ViewPools#execute()} method to invoke the remote operation.
   *
   * @param content the {@link com.appspot.symbidrive_997.symbidrive.model.SymbidriveViewPoolsRequest}
   * @return the request
   */
  public ViewPools viewPools(com.appspot.symbidrive_997.symbidrive.model.SymbidriveViewPoolsRequest content) throws java.io.IOException {
    ViewPools result = new ViewPools(content);
    initialize(result);
    return result;
  }

  public class ViewPools extends SymbidriveRequest<com.appspot.symbidrive_997.symbidrive.model.SymbidriveViewPoolsResponse> {

    private static final String REST_PATH = "pool/view_pools";

    /**
     * Create a request for the method "view_pools".
     *
     * This request holds the parameters needed by the the symbidrive server.  After setting any
     * optional parameters, call the {@link ViewPools#execute()} method to invoke the remote
     * operation. <p> {@link
     * ViewPools#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param content the {@link com.appspot.symbidrive_997.symbidrive.model.SymbidriveViewPoolsRequest}
     * @since 1.13
     */
    protected ViewPools(com.appspot.symbidrive_997.symbidrive.model.SymbidriveViewPoolsRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.symbidrive_997.symbidrive.model.SymbidriveViewPoolsResponse.class);
    }

    @Override
    public ViewPools setAlt(java.lang.String alt) {
      return (ViewPools) super.setAlt(alt);
    }

    @Override
    public ViewPools setFields(java.lang.String fields) {
      return (ViewPools) super.setFields(fields);
    }

    @Override
    public ViewPools setKey(java.lang.String key) {
      return (ViewPools) super.setKey(key);
    }

    @Override
    public ViewPools setOauthToken(java.lang.String oauthToken) {
      return (ViewPools) super.setOauthToken(oauthToken);
    }

    @Override
    public ViewPools setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ViewPools) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ViewPools setQuotaUser(java.lang.String quotaUser) {
      return (ViewPools) super.setQuotaUser(quotaUser);
    }

    @Override
    public ViewPools setUserIp(java.lang.String userIp) {
      return (ViewPools) super.setUserIp(userIp);
    }

    @Override
    public ViewPools set(String parameterName, Object value) {
      return (ViewPools) super.set(parameterName, value);
    }
  }
