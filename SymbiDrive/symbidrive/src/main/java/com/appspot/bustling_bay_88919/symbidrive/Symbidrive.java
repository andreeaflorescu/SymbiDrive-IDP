...
public class Symbidrive extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param content the {@link com.appspot.bustling_bay_88919.symbidrive.model.SymbidriveViewPoolsRequest}
   * @return the request
   */
  public ViewPools viewPools(com.appspot.bustling_bay_88919.symbidrive.model.SymbidriveViewPoolsRequest content) throws java.io.IOException {
    ViewPools result = new ViewPools(content);
    initialize(result);
    return result;
  }

  public class ViewPools extends SymbidriveRequest<com.appspot.bustling_bay_88919.symbidrive.model.SymbidriveViewPoolsResponse> {
     ...
     * @since 1.13
     */
    protected ViewPools(com.appspot.bustling_bay_88919.symbidrive.model.SymbidriveViewPoolsRequest content) {
      super(Symbidrive.this, "POST", REST_PATH, content, com.appspot.bustling_bay_88919.symbidrive.model.SymbidriveViewPoolsResponse.class);
    }
