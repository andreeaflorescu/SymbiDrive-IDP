...
public class JoinedPoolDetailsFragment extends Fragment {
    private SupportMapFragment fragment;
    private GoogleMap map;
    private Bundle data;
    public JoinedPoolDetailsFragment() {
                ...
                new AsyncTask<Void, Void, SymbidriveUserInfoResponse>() {
                    ...
                    protected void onPostExecute(SymbidriveUserInfoResponse response) {
                        if (response != null) {
                            ...
                            if (telephone != null) {
                                Log.v("cucu", "==========================");
                                Log.v("cucu", telephone);
                                ((TextView) getActivity().findViewById(R.id.tv_telephone_number)).setText(telephone);
                            }
                        }
                    }
                };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_joined_pool_details, container, false);
        this.data = getArguments();
        ((TextView) rootView.findViewById(R.id.driver_name)).setText(data.getString("driverUserName"));
//        ((TextView) rootView.findViewById(R.id.tv_date)).setText(data.getString("date").substring(0, 11));
        getUserInfoTask();
        return rootView;
    }

    private void initInterfaceElements(View rootView, Bundle data) {
        ((TextView) rootView.findViewById(R.id.driver_name)).setText(data.getString("driverUserName"));
        ((TextView) rootView.findViewById(R.id.tv_date)).setText(data.getString("date"));
    }
